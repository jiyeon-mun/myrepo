...
public class GuestBookDAO { // 데이터베이스 연결 실행(접근)
    ...
    public List<GuestBookDTO> select() { // 방명록 조회작업
    ...
    public boolean insert(GuestBookDTO dto) { // 실질적인 데이터 추가
    ...
    public boolean update(GuestBookDTO dto) { // context에 수정한 내용 반영되도록
